package com.fissionstudios.InstaSave.Activities;
...
import com.fissionstudios.InstaSave.Adapters.RecyclerViewAdapter;
import com.fissionstudios.InstaSave.Intro.IntroActivity;
import com.fissionstudios.InstaSave.Model.Files;
import com.fissionstudios.InstaSave.R;
import com.fissionstudios.InstaSave.Utils.Constant;
import com.fissionstudios.InstaSave.Utils.Constants;
import com.fissionstudios.InstaSave.Utils.SettingsActivity;
import com.fissionstudios.InstaSave.Utils.Source;
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (path.endsWith(".jpg")) {
                        ...
                        Intent sharingIntent = new Intent(Intent.ACTION_SEND);
                        sharingIntent.setType("fissionstudios/*");
                        sharingIntent.putExtra(Intent.EXTRA_TEXT, "Downloaded using " + getResources().getString(R.string.app_name) + " android application");
                        sharingIntent.putExtra(Intent.EXTRA_STREAM, mainUri);
                        sharingIntent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                        sharingIntent.setPackage("com.instagram.android");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response != null) {
                    ...
                    videoUrl = Source.getURL(htmlSource, "property=\"og:fissionstudios\" content=\"([^\"]+)\"");
